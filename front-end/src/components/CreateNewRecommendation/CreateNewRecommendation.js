...
export default function CreateNewRecommendation({ onCreateNewRecommendation = () => 0, disabled = false }) {
  ...
  return (
    <Container>
      <Input data-cy="nameVideoInput" type="text" placeholder="Name" value={name} onChange={e => setName(e.target.value)} disabled={disabled} />
      ...
      <Button data-cy="sendButton" onClick={() => handleCreateRecommendation()} disabled={disabled}>
